...
import { Video, Wand2, Plus, Clock, ChevronRight, FileVideo, LayoutTemplate } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white overflow-hidden relative selection:bg-primary/30">
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
                <div className="absolute -top-[20%] -left-[10%] w-[60%] h-[60%] bg-purple-500/10 rounded-full blur-[120px] mix-blend-screen animate-pulse-slow"></div>
                <div className="absolute top-[40%] -right-[10%] w-[50%] h-[50%] bg-blue-500/10 rounded-full blur-[120px] mix-blend-screen animate-pulse-slower"></div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 relative z-10 flex flex-col h-screen">
                ...
                <header className="flex justify-between items-center mb-16">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-xl tracking-tight">ViralPilot</span>
                    </div>
                ...
                <main className="flex-1 flex flex-col justify-center max-w-5xl mx-auto w-full -mt-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
                        ...
                        {/* Analyzer Card */}
                        <div
                            onClick={() => window.location.href = 'https://viralpilot.fr'}
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <div>
                                    ...
                                    <h2 className="text-2xl font-semibold mb-2 text-white group-hover:text-blue-300 transition-colors">Viral Pilot V2</h2>
                                    <p className="text-gray-400 text-sm leading-relaxed">
                                ...
                                <div className="flex items-center text-sm font-medium text-blue-400 opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
                                    Go to Viral Pilot <ChevronRight className="w-4 h-4 ml-1" />
                                </div>
                            </div>
                        </div>
                    </div>
