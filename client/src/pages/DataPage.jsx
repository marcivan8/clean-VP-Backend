            ...
            <main style={{ maxWidth: 720, margin: '0 auto', padding: '64px 24px 96px' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
                    ...
                    <Section title={t('aiProcessing.title')}>
                        <p>{t('aiProcessing.p1')}</p>
                        <p>{t('aiProcessing.p2')}</p>
                    </Section>

                    <Section title={t('deletion.title')}>
                        <p>{t('deletion.p1')}</p>
                        <p>{t('deletion.p2')}</p>
                        <p>{t('deletion.p3')}</p>
                    </Section>
                                ...
                                <FaqItem
                                    ...
                                    answer={
                                        item.aPre !== undefined ? (
                                            <>
                                                {item.aPre}
                                                <a href="/privacy" style={{ color: 'var(--accent)', textDecoration: 'underline' }}>{item.aLinkText}</a>
                                                {item.aPost}
                                            </>
                                        ) : item.a
                                    }
