...
const IDELayout = ({ children, mode = 'editor' }) => {
    ...
    const handleExportConfirm = async (settings) => {
        ...
        try {
            ...
            // be configured before it worked at all, applied no colour grade
            // (R55) and no multicam crop (R14), and duplicated a pipeline FFmpeg
                ...
                <div className="flex-1 flex flex-col md:flex-row overflow-hidden relative pb-14 md:pb-0">
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-hidden flex flex-col">
                            <ReasoningPanel className="flex-1" />
                        </div>
                    </aside>
                </div>
